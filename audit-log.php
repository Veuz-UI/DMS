                                            ...
                                            <table id="event-table" class="table table-resizable table-striped">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><a href="#" class="link-color">arshad@veuz.in</a><span
                                                                class="resize"></span></td>
                                                        <td>Shared to ankhakv@gmail.com as Viewer<span
                                                                class="resize"></span></td>
                        ...
                        <div class="update-stg">
                            ...
                            <div class="row mt-2">
                                <div class="col-md-6 pl-3">
                                    <a href="#" class="add-stage-link"><i class="bx bx-plus-circle"></i>Add Stages</a>
                                </div>
                                <div class="col-md-6">
                                    <div
