...
<body>
                ...
                <div class="rightside-menu">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="nav1" role="tabpanel">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <ul class="nav nav-pills event-tab-nav" role="tablist">
                                        ...
                                        <li class="nav-item waves-effect waves-light" role="presentation">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#doc-list-tab"
                                        ...
                                        <li class="nav-item waves-effect waves-light" role="presentation">
                                            <a class="nav-link" data-bs-toggle="tab" href="#doc-grid-tab" role="tab"
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="doc-list-tab" role="tabpanel">
                                        ...
                                        <table id="event-table" class="table table-resizable table-striped">
                                            <thead>
                                                <tr>
                                                    <th width="46px"><input class="form-check-input " type="checkbox"
                                                            name="Main_Checkbox" id="selectAll"><span
                                                            class="resize"></span>
                                                    </th>
                                                    ...
                                                    <th>
                                                        <div class="dropdown common-drpdwn column-dropdown">                                                  
                                                            <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false" id="dropdownMenuClickableInside"> <i class="fas fa-ellipsis-v dots" aria-hidden="true"></i></a>
                                                            <div class="dropdown-menu dropdown-menu-md" aria-labelledby="dropdownMenuClickableInside">
                                                                <div class="drop-header">
                                                                    <h5>Columns</h5>
                                                                </div>
                                                                <div class="form-grp mb-0">
                                                                    <label class="form-label mb-2">Select columns for folder Inbox</label>
                                                                    <div class="update-stg">
                                                                        ...
                                                                        <div class="drop__list drag-drop " id="drop-items">
                                                                            <div class="row mb-1 drop__card">
                                                                                ...
                                                                                <div class="col-lg-1 ps-0 pe-1 dlt-stage">
                                                                                    <i class="far fa-trash-alt" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" aria-hidden="true"></i><span class="sr-only">Delete</span>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row mb-1 drop__card">
                                                                                <div class="col-md-11 ps-35 pe-0">
                                                                        ...
                                                                        <div class="row mt-2">
                                                                            <div class="col-md-6 pl-3">
                                                                                <a href="#" class="add-stage-link"><i class="bx bx-plus-circle"></i>Add Columns</a>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-check form-radio-outline form-radio-success evnt-radio float-right">
                                                                                    <input class="form-check-input" type="checkbox" name="formRadio64" id="formRadio64">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><a href="event-detail.php"
                                                            class="link-color">white_background.png</a><span
                                                            class="resize"></span></td>

                                                    <td class="tag-dov"> <span class="inbox">Inbox</span> <span
                                ...
                                <div class="tab-pane" id="doc-grid-tab" role="tabpanel">
                                        ...
                                        <div class="row gx-3">
                                                ...
                                                <div class="kanban-bx">
                                                    <div class="doc-img">
                                                        <div class="form-check form-radio-success">
                                                            <input class="form-check-input" type="radio" name="rad1"
                                                                id="">
                                                        </div>
                                                        <svg width="30" height="30" viewBox="0 0 60 61" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                                    ...
                                                    <div class="doc-content">
                                                        ...
                                                        <div class="bottom-kandoc">
                                                            <p> 07/30/2023</p>
                                                            <div><img src="assets/images/users/avatar-2.jpg" alt="">
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="kanban-bx">
                                                    <div class="doc-img">
                                                        <div class="form-check form-radio-success">
                                                            <input class="form-check-input" type="radio" name="rad2"
                                                                id="">
                                                        </div>
                                                        <svg width="32" height="34" viewBox="0 0 131 136" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="col-md-2">
                                                <div class="kanban-bx">
                                                    <div class="doc-img">
                                                        <div class="form-check form-radio-success">
                                                            <input class="form-check-input" type="radio" name="rad3"
                                                                id="">
                                                        </div>
                                                        <svg width="30" height="34" viewBox="0 0 96 128" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                            ...
                                            <div class="col-md-2">
                                                <div class="kanban-bx">
                                                    <div class="doc-img">
                                                        <div class="form-check form-radio-success">
                                                            <input class="form-check-input" type="radio" name="rad4"
                                                                id="">
                                                        </div>
                                                        <svg width="30" height="30" viewBox="0 0 60 61" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="col-md-2">
                                                <div class="kanban-bx">
                                                    <div class="doc-img">
                                                        <div class="form-check form-radio-success">
                                                            <input class="form-check-input" type="radio" name="rad5"
                                                                id="">
                                                        </div>
                                                        <svg width="30" height="34" viewBox="0 0 96 128" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="col-md-2">
                                                <div class="kanban-bx">
                                                    <div class="doc-img">
                                                        <div class="form-check form-radio-success">
                                                            <input class="form-check-input" type="radio" name="rad6"
                                                                id="">
                                                        </div>
                                                        <svg width="30" height="30" viewBox="0 0 60 61" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="col-md-2">
                                                <div class="kanban-bx">
                                                    <div class="doc-img">
                                                        <div class="form-check form-radio-success">
                                                            <input class="form-check-input" type="radio" name="rad7"
                                                                id="">
                                                        </div>
                                                        <svg width="30" height="34" viewBox="0 0 96 128" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="col-md-2">
                                                <div class="kanban-bx">
                                                    <div class="doc-img">
                                                        <div class="form-check form-radio-success">
                                                            <input class="form-check-input" type="radio" name="rad8"
                                                                id="">
                                                        </div>
                                                        <svg width="32" height="34" viewBox="0 0 131 136" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="col-md-2">
                                                <div class="kanban-bx">
                                                    <div class="doc-img">
                                                        <div class="form-check form-radio-success">
                                                            <input class="form-check-input" type="radio" name="rad9"
                                                                id="">
                                                        </div>
                                                        <svg width="30" height="34" viewBox="0 0 96 128" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="col-md-2">
                                                <div class="kanban-bx">
                                                    <div class="doc-img">
                                                        <div class="form-check form-radio-success">
                                                            <input class="form-check-input" type="radio" name="rad11"
                                                                id="">
                                                        </div>
                                                        <svg width="30" height="30" viewBox="0 0 60 61" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="col-md-2">
                                                <div class="kanban-bx">
                                                    <div class="doc-img">
                                                        <div class="form-check form-radio-success">
                                                            <input class="form-check-input" type="radio" name="rad12"
                                                                id="">
                                                        </div>
                                                        <svg width="30" height="34" viewBox="0 0 96 128" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="right-side-topbar">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <ul class="nav nav-pills event-tab-nav" role="tablist">
                                        ...
                                        <li class="nav-item waves-effect waves-light" role="presentation">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#doc-list-tab1"
                                                role="tab" aria-selected="false" tabindex="-1">
                                                <button type="button"
                                                    class="btn btn-kanlist ml-15 waves-effect waves-light"
                                                    data-bs-toggle="tooltip" data-bs-placement="bottom" title="List">
                                        ...
                                        <table id="event-table" class="table table-resizable table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><input class="form-check-input check-input" type="checkbox"
                                                            id="formCheck1"><span class="resize"></span></td>
                                                    <td><a href="#" class="link-color">white_background.png</a><span
                                                            class="resize"></span></td>
                            ...
                            <div class="right-side-topbar">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <ul class="nav nav-pills event-tab-nav" role="tablist">
                                        ...
                                        <li class="nav-item waves-effect waves-light" role="presentation">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#doc-list-tab2"
                                                role="tab" aria-selected="false" tabindex="-1">
                                                <button type="button"
                                                    class="btn btn-kanlist ml-15 waves-effect waves-light"
                                                    data-bs-toggle="tooltip" data-bs-placement="bottom" title="List">
                            ...
                            <div class="right-side-topbar">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <ul class="nav nav-pills event-tab-nav" role="tablist">
                                        ...
                                        <li class="nav-item waves-effect waves-light" role="presentation">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#doc-list-tab3"
                                                role="tab" aria-selected="false" tabindex="-1">
                                                <button type="button"
                                                    class="btn btn-kanlist ml-15 waves-effect waves-light"
                                                    data-bs-toggle="tooltip" data-bs-placement="bottom" title="List">
                            ...
                            <div class="right-side-topbar">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <ul class="nav nav-pills event-tab-nav" role="tablist">
                                        ...
                                        <li class="nav-item waves-effect waves-light" role="presentation">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#doc-list-tab4"
                                                role="tab" aria-selected="false" tabindex="-1">
                                                <button type="button"
                                                    class="btn btn-kanlist ml-15 waves-effect waves-light"
                                                    data-bs-toggle="tooltip" data-bs-placement="bottom" title="List">
                            ...
                            <div class="right-side-topbar">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <ul class="nav nav-pills event-tab-nav" role="tablist">
                                        ...
                                        <li class="nav-item waves-effect waves-light" role="presentation">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#doc-list-tab5"
                                                role="tab" aria-selected="false" tabindex="-1">
                                                <button type="button"
                                                    class="btn btn-kanlist ml-15 waves-effect waves-light"
                                                    data-bs-toggle="tooltip" data-bs-placement="bottom" title="List">
    ...
    <!-- <div class="modal fade" id="colum-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                            ...
                            <div class="drop__list drag-drop" id="drop-items">
                                <div class="row mb-1 drop__card">
                                    ...
                                    <div class="col-lg-1 dlt-stage">
                                        <i class="far fa-trash-alt" data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="Delete"></i>
                                    </div>
                                </div>
                                <div class="row mb-1 drop__card">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-6">
                                    <div
                                        ...
                                        <input class="form-check-input" type="checkbox" name="formRadio64"
                                            id="formRadio64" autocompleted="">
                                        <label class="form-check-label" for="formRadio64">
                                            Also apply to subfolders
                                        </label>
                                    </div>
    ...
    <div class="modal fade" id="retention-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                            ...
                            <div class="retention-edit">
                                <div class="form-grp">
                                    <div class="form-check form-radio-outline form-radio-success evnt-radio">
                                        <input class="form-check-input retention-rad" type="radio" name="formRad1"
                                            id="formRad1" value="1" checked>
                        ...
                        <div class="retention-content" id="retention-content2" style="display: none;">
                            <div class="col-md-12">
                                <div class="form-grp retention-content1">
                                    ...
                                    <div class="d-flex">
                                        <input class="form-control" type="number" style="width: 20%;margin-right: 8px;">
                            ...
                            <div class="col-md-12">
                                <div class="form-grp subfoldr">
                                    <div class="form-check form-radio-outline form-radio-success evnt-radio">
                                        <input class="form-check-input" type="checkbox" name="formRad11" id="formRad11">
    ...
    <div class="modal fade" id="workflow-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    ...
                    <div class="row workflow-modal">
                        ...
                        <div class="col-md-12">
                            <div class="workflow-edit">
                                <div class="form-grp">
                                    <div class="form-check form-radio-outline form-radio-success evnt-radio">
                                        <input class="form-check-input workflow-rad" type="radio" name="wrkRad1"
                                            id="wrkRad1" value="1" checked>
                        ...
                        <div class="workflow-content" id="workflow-content2" style="display: none;">
                            <div class="col-md-12">
                                <div class="btn-group workflow-btns" role="group"
                                    ...
                                    <label class="btn btn-success" for="btnradio4">Acknowledgement</label>
                                </div>
                                <div class="workflow-tab-content">
                                                ...
                                                <div class="res-type-div">
                                                    <div
                                                        ...
                                                        <input class="form-check-input" type="radio"
                                                            name="resolution-type" id="res-typ1" checked>
                                        ...
                                        <div class="move-wrkflw">
                                            <div class="form-grp">
                                                <div class="form-check form-switch form-switch-md" dir="ltr">
                                                    <input class="form-check-input" type="checkbox" id="move-wrk-check">
                                                    <label class="form-check-label" for="move-wrk-check">Move after
                                                        successful
                                                        workflow</label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="workflow-tab-content3" style="display: none;">
                                        <div class="form-grp">
                                            <label for="">After everyone has approved, move the document
                                                to</label>
                                            <input type="text" class="form-control" placeholder="Choose a folder">
                                        </div>
                                    </div>
                                    ...
                                    <div class="workflow-tab-content5" style="display: none;">
                                        <div class="form-check form-radio-outline form-radio-success evnt-radio">
                                            <input class="form-check-input" type="checkbox" name="fmcheck1"
                                                id="fmcheck1">
                                    ...
                                    <div class="workflow-tab-content6">
                                        <div class="mb-2">
                                            <div class="form-check form-radio-outline form-radio-success evnt-radio">
                                                <input class="form-check-input" type="radio" name="fmcheck2"
                                                    id="fmcheck2">
                                        ...
                                        <div class="mb-2">
                                            <div class="form-check form-radio-outline form-radio-success evnt-radio">
                                                <input class="form-check-input" type="radio" name="fmcheck3"
                                                    id="fmcheck3">
                                        ...
                                        <div class="mb-2">
                                            <div class="form-check form-radio-outline form-radio-success evnt-radio">
                                                <input class="form-check-input" type="radio" name="fmcheck4"
                                                    id="fmcheck4">
    ...
    <div class="modal fade" id="numbering-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="row numbering-modal">
                        ...
                        <div class="col-md-12">
                            <div class="numbering-edit">
                                <div class="form-grp">
                                    <div class="form-check form-radio-outline form-radio-success evnt-radio">
                                        <input class="form-check-input numbering-rad" type="radio" name="numberingRad1"
                                            id="numberingRad1" value="1" checked>
                        ...
                        <div class="numbering-content" id="numbering-content2" style="display: none;">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-2">
                                        <div class="form-check form-radio-outline form-radio-success evnt-radio">
                                            <input class="form-check-input" type="radio" name="numcheck2"
                                                id="numcheck2">
                                    ...
                                    <div class="mb-2">
                                        <div class="form-check form-radio-outline form-radio-success evnt-radio">
                                            <input class="form-check-input" type="radio" name="numcheck3"
                                                id="numcheck3">
