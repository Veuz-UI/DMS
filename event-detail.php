...
<html lang="en">
    ...
    <style>
            ...
            <div class="page-content">
                            ...
                            <div class="top-bar d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex flex-wrap gap-3 event-btns ">
                                    <div class="btn-group btn-group-lg" role="group" aria-label="Basic example">
                                        <button type="button" class="btn btn-outline-primary bg-1" data-bs-toggle="modal" data-bs-target="#create-folder"><i class="fas fa-folder-open"></i>+Folder</button>
                                        <a href="modify.php"><button type="button" class="btn btn-outline-primary bg-2"><i class="fas fa-users-cog"></i></i>Modify</button></a>
                                        <!-- <button type="button" class="btn btn-outline-primary bg-3" data-bs-toggle="modal" data-bs-target="#colum-modal"><i class="fa-solid fa-table-columns"></i>Columns</button> -->
                                        <a href="meta.php"><button type="button" class="btn btn-outline-primary clr4"><i class="fa-solid fa-tag"></i>Meta</button></a>
                                        <button type="button" class="btn btn-outline-primary clr5" data-bs-toggle="modal" data-bs-target="#retention-modal"><i class="far fa-folder"></i>Retention</button>
                                        <button type="button" class="btn btn-outline-primary clr6" data-bs-toggle="modal" data-bs-target="#workflow-modal"><i class="fa-solid fa-handshake"></i>Workflow</button>
                                        <a href="audit-log.php"><button type="button" class="btn btn-outline-primary clr7"><i class="far fa-sticky-note"></i>Audit Log</button></a>
                                        <button type="button" class="btn btn-outline-primary bg-3" data-bs-toggle="modal" data-bs-target="#numbering-modal"><i class="fas fa-list-ol"></i>Numbering</button>
                                ...
                                <div class="d-flex rightside-btns">
                                    ...
                                    <div class="input-group search-inpt">
                                        ...
                                        <div class="dropdown drpdwn-fg">
                                            <button type="button" class="input-group-text input-group-text-right btn-export btn-filter waves-effect waves-light btn-sm small dropdown-toggle h-100"
                ...
                <div class="main-content-div">
                    <div class="leftside-menu">
                        ...
                        <button type="button" class="btn btn-create-new br-50 small" data-bs-toggle="modal" data-bs-target="#create-section">
                    ...
                    <div class="rightside-menu">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="nav1" role="tabpanel">
                                ...
                                <div class="file-detail-tab">
                                   <div class="row h-100">
                                    <div class="col-md-9 border-right">
                                        <div class="right-side-topbar file-detail-topbar align-items-center">
                                            <div class="file-detail-header">
                                                ...
                                                <div class="file-detail-header-title">
                                                    <h4>white_background.png</h4>
                                                    <ul class="breadcrump">
                                                        <li><a href="#">Inbox <span>/</span></a></li>
                                                        <li><a href="#">white_background.png</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <button type="button"
                                        ...
                                        <div class="doc-details">
                                            <div class="row">
                                                <div class="d-flex flex-wrap gap-1 mb-3">
                                                    <button type="button" class="btn btn-outline-primary waves-effect waves-light btn-xs">Lock file</button>
                                                    <button type="button" class="btn btn-outline-info waves-effect waves-light btn-xs">Upload new version</button>
                                                    <button type="button" class="btn btn-outline-success waves-effect waves-light btn-xs">Start approval workflow</button>
                                                    <button type="button" class="btn btn-outline-warning waves-effect waves-light btn-xs">Start acknowledgment workflow</button>
                                                    <button type="button" class="btn btn-outline-danger waves-effect waves-light btn-xs">Start eID workflow</button>
                                                
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Document ID</label>
                                                        <input type="text" class="form-control" value="13498153" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Date</label>
                                                        <input type="date" class="form-control" value="14 Nov 2023" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Due date</label>
                                                        <input type="date" class="form-control" value="18 Nov 2023" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">OCR language</label>
                                            ...
                                            <div class="row-selected me-0" style="display: none;">
                                                ...
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn-primary dropdown-toggle"
                                                        data-bs-toggle="dropdown" aria-expanded="false">Download Log</button>
                                        ...
                                        <div class="audit-table-overflow">
                                            <table id="event-table" class="table table-resizable table-striped">
                                                <thead>
                                                    <tr>
                                                        <th width="46px"><input class="form-check-input " type="checkbox" name="Main_Checkbox" id="selectAll"><span class="resize"></span>
                                                        </th>
                                                        <th width="200px">Time<span class="resize"></span></th>
                                                        <th width="200px">User<span class="resize"></span></th>
                                                        <th>Action<span class="resize"></span></th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>16.11.2023 | 04:10:24<span class="resize"></span></td>
                                                        <td><a href="#" class="link-color">arshad@veuz.in</a><span class="resize"></span></td>     
                                                        <td>Shared to ankhakv@gmail.com as Viewer<span class="resize"></span></td>
                                    ...
                                    <div class="col-md-3 col-lap-4 aos-init aos-animate" data-aos="fade-up">
                                        <div class="right-side-nav">
                                            <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                                                <li class="nav-item" role="presentation">
                                                    <a class="nav-link active" data-bs-toggle="tab" href="#reminder" role="tab" aria-selected="true">
                                                        <span>Reminders</span>
                                                    </a>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                    <a class="nav-link" data-bs-toggle="tab" href="#share-to" role="tab" aria-selected="false">
                                                        <span>Share to</span>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-bs-toggle="tab" href="#retention" role="tab" aria-selected="false">
                                                        <span>Retention</span>
                                                    </a>
                                                </li>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active show" id="reminder" role="tabpanel">
                                                <div class="row">
                                                    <div class="col-md-12 mt-2">
                                                        <button type="button" class="btn btn-primary waves-effect waves-light btn-xs br-50 small">Add New Reminder</button>
                                                        <div class="reminder-div">
                                                        
                                                            <div class="single-reminder">
                                                                <h6>2023-11-17 @ 09:39</h6> <a href="#" class="reminder-dlt"><i class="bx bx-trash"></i></a>
                                                            </div>
                                                            <div class="single-reminder">
                                                                <h6>2023-11-17 @ 09:39</h6> <a href="#" class="reminder-dlt"><i class="bx bx-trash"></i></a>
                                                            </div>
                                            ...
                                            <div class="tab-pane" id="share-to" role="tabpanel">
                                                <div class="row">
                                                    <div class="col-md-12 mt-2">
                                                        <button type="button" class="btn btn-primary waves-effect waves-light btn-xs br-50 small">Share</button>
                                                        <div class="share-div">
                                                        
                                                            <div class="single-share">
                                                                <h6>anakha@veuz.in</h6>
                                                            </div>
                                                            <div class="single-share">
                                                                <h6>arshad@veuz.in</h6>
                                                            </div>
                                                            <div class="single-share">
                                                                <h6>nasim@veuz.in</h6>
                                                            </div>
                                                            <div class="single-share">
                                                                <h6>bisharu@veuz.in</h6>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="tab-pane" id="retention" role="tabpanel">
                                                <div class="row">
                                                    <div class="col-md-12 mt-2">                                                     
                                                        <button type="button" class="btn btn-primary waves-effect waves-light btn-xs br-50 small">Add</button>
                                                        <div class="retention-div">
                                                        
                                                            <div class="single-retention">
                                                                <span class="retention-tym"><i class="bx bx-time-five"></i>10:30 am</span>
                                                                <h6>Moved to the Recycle Bin at 2023-11-24</h6>
                                                            </div>
                                                            <div class="single-retention">
                                                                <span class="retention-tym"><i class="bx bx-time-five"></i>10:15 am</span>
                                                                <h6>Moved to the Recycle Bin at 2023-11-24</h6>
                                                            </div>
                                                            <div class="single-retention">
                                                                <span class="retention-tym"><i class="bx bx-time-five"></i>09:30 am</span>
                                                                <h6>Moved to the Recycle Bin at 2023-11-24</h6>
                                                            </div>
                                                            <div class="single-retention">
                                                                <span class="retention-tym"><i class="bx bx-time-five"></i>09:15 am</span>
                                                                <h6>Moved to the Recycle Bin at 2023-11-24</h6>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="tab-pane" id="nav2" role="tabpanel">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <ul class="nav nav-pills event-tab-nav" role="tablist">
                                            ...
                                            <li class="nav-item waves-effect waves-light" role="presentation">
                                                <a class="nav-link active" data-bs-toggle="tab" href="#doc-list-tab1" role="tab"
                                            ...
                                            <li class="nav-item waves-effect waves-light" role="presentation">
                                                <a class="nav-link" data-bs-toggle="tab" href="#doc-grid-tab1" role="tab"
                                                    aria-selected="false" tabindex="-1">
                                                    <button type="button"
                                                        class="btn btn-kanlist ml-15 waves-effect waves-light"
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="doc-list-tab1" role="tabpanel">
                                        <div class="event-table">
                                            <table id="event-table" class="table table-resizable table-striped">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><input class="form-check-input check-input" type="checkbox" id="formCheck1"><span class="resize"></span></td>
                                                        <td><a href="#" class="link-color"><i class="fa-regular fa-folder folder-icn"></i>Arabic_Folder</a><span class="resize"></span></td>
        
                                                        <td class="tag-dov"> <span class="inbox">Inbox</span> <span class="validated">Validated</span>
                                                        </td>
                                                        <td>Arshad</td>
                                                        <td>PNG</td>
                                                        <td>07/30/2023</td>
                                                    ...
                                                    <tr>
                                                        <td><input class="form-check-input check-input" type="checkbox" id="formCheck1"><span class="resize"></span></td>
                                                        <td><a href="#" class="link-color">50px_x_50px_coloured_logo_on_white_background.svg</a><span class="resize"></span></td>
                                                    ...
                                                    <tr>
                                                        <td><input class="form-check-input check-input" type="checkbox" id="formCheck1"><span class="resize"></span></td>
                                                        <td><a href="#" class="link-color">white_background.png</a><span class="resize"></span></td>
                                             
                                                   
                                                        <td class="tag-dov"> <span class="inbox">Inbox</span> <span class="tovalidated">To Validated</span>
                                                        </td>
                                                        <td>Arshad</td>
                                                        <td>PNG</td>
                                                        <td>07/30/2023</td>
                                    ...
                                    <div class="tab-pane" id="doc-grid-tab1" role="tabpanel">
                                            ...
                                            <div class="row gx-3">
                                                    ...
                                                    <div class="kanban-bx">
                                                        <div class="doc-img">
                                                            <div class="form-check form-radio-success">
                                                                <input class="form-check-input" type="radio" name="rad1" id="">                                                            
                                                            </div>
                                                            <svg width="30" height="30" viewBox="0 0 60 61" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M52.333 0.5H7.66699C3.43934 0.5 0 3.93945 0 8.16711V52.833C0 57.0605 3.43934 60.5 7.66699 60.5H52.333C56.5607 60.5 60 57.0605 60 52.8329V8.16711C60 3.93945 56.5607 0.5 52.333 0.5ZM56.4659 52.833C56.4659 55.112 54.6118 56.9659 52.333 56.9659H7.66699C5.38805 56.9659 3.53402 55.1118 3.53402 52.833V46.3869L15.1655 36.4903C15.5899 36.1291 16.2091 36.1257 16.6376 36.4815L23.9236 42.5316C24.6261 43.1149 25.6574 43.0671 26.303 42.4208L43.615 25.0824C43.9279 24.7689 44.2927 24.7385 44.4831 24.7482C44.6729 24.7579 45.0333 24.8257 45.3125 25.1696L56.466 38.9028L56.4659 52.833ZM56.4659 33.2967L48.0558 22.9413C47.2218 21.9143 45.9855 21.2864 44.6641 21.2185C43.3437 21.1517 42.0489 21.6488 41.1141 22.5852L24.9413 38.7829L18.8955 33.7627C17.1425 32.307 14.6108 32.3221 12.8753 33.7988L3.53402 41.7467V8.16711C3.53402 5.88816 5.38805 4.03414 7.66699 4.03414H52.333C54.612 4.03414 56.4659 5.88816 56.4659 8.16711V33.2967Z" fill="#193567"/>
                                                                <path d="M18.8876 7.88208C14.1889 7.88208 10.3665 11.7047 10.3665 16.4031C10.3665 21.1017 14.1891 24.9242 18.8876 24.9242C23.5861 24.9242 27.4086 21.1017 27.4086 16.4031C27.4086 11.7046 23.5862 7.88208 18.8876 7.88208ZM18.8876 21.3902C16.1376 21.3902 13.9005 19.1529 13.9005 16.4031C13.9005 13.6532 16.1376 11.4161 18.8876 11.4161C21.6375 11.4161 23.8746 13.6533 23.8746 16.4031C23.8746 19.1529 21.6375 21.3902 18.8876 21.3902Z" fill="#193567"/>
                                                                </svg>
                                                        ...
                                                        <div class="doc-content">
                                                            ...
                                                            <div class="bottom-kandoc">
                                                                <p>	07/30/2023</p>  
                                                                <div><img src="assets/images/users/avatar-2.jpg" alt=""></div>                                                          
                                                            </div>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="kanban-bx">
                                                        <div class="doc-img">
                                                            <div class="form-check form-radio-success">
                                                                <input class="form-check-input" type="radio" name="rad4" id="">                                                            
                                                            </div>
                                                            <svg width="30" height="30" viewBox="0 0 60 61" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M52.333 0.5H7.66699C3.43934 0.5 0 3.93945 0 8.16711V52.833C0 57.0605 3.43934 60.5 7.66699 60.5H52.333C56.5607 60.5 60 57.0605 60 52.8329V8.16711C60 3.93945 56.5607 0.5 52.333 0.5ZM56.4659 52.833C56.4659 55.112 54.6118 56.9659 52.333 56.9659H7.66699C5.38805 56.9659 3.53402 55.1118 3.53402 52.833V46.3869L15.1655 36.4903C15.5899 36.1291 16.2091 36.1257 16.6376 36.4815L23.9236 42.5316C24.6261 43.1149 25.6574 43.0671 26.303 42.4208L43.615 25.0824C43.9279 24.7689 44.2927 24.7385 44.4831 24.7482C44.6729 24.7579 45.0333 24.8257 45.3125 25.1696L56.466 38.9028L56.4659 52.833ZM56.4659 33.2967L48.0558 22.9413C47.2218 21.9143 45.9855 21.2864 44.6641 21.2185C43.3437 21.1517 42.0489 21.6488 41.1141 22.5852L24.9413 38.7829L18.8955 33.7627C17.1425 32.307 14.6108 32.3221 12.8753 33.7988L3.53402 41.7467V8.16711C3.53402 5.88816 5.38805 4.03414 7.66699 4.03414H52.333C54.612 4.03414 56.4659 5.88816 56.4659 8.16711V33.2967Z" fill="#193567"/>
                                                                <path d="M18.8876 7.88208C14.1889 7.88208 10.3665 11.7047 10.3665 16.4031C10.3665 21.1017 14.1891 24.9242 18.8876 24.9242C23.5861 24.9242 27.4086 21.1017 27.4086 16.4031C27.4086 11.7046 23.5862 7.88208 18.8876 7.88208ZM18.8876 21.3902C16.1376 21.3902 13.9005 19.1529 13.9005 16.4031C13.9005 13.6532 16.1376 11.4161 18.8876 11.4161C21.6375 11.4161 23.8746 13.6533 23.8746 16.4031C23.8746 19.1529 21.6375 21.3902 18.8876 21.3902Z" fill="#193567"/>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="kanban-bx">
                                                        <div class="doc-img">
                                                            <div class="form-check form-radio-success">
                                                                <input class="form-check-input" type="radio" name="rad5" id="">                                                            
                                                            </div>
                                                            <svg width="30" height="34" viewBox="0 0 96 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M95.2188 27.448L68.552 0.78125C68.052 0.28125 67.375 0 66.6665 0H10.6665C4.78375 0 0 4.78375 0 10.6667V117.334C0 123.216 4.78375 128 10.6667 128H85.3335C91.2163 128 96 123.216 96 117.333V29.3333C96 28.625 95.7188 27.948 95.2188 27.448ZM69.3333 9.10425L86.8958 26.6667H74.6665C71.7265 26.6667 69.3333 24.2735 69.3333 21.3335V9.10425ZM90.6667 117.333C90.6667 120.273 88.2735 122.666 85.3335 122.666H10.6667C7.72675 122.666 5.3335 120.273 5.3335 117.333V10.6667C5.3335 7.72675 7.72675 5.3335 10.6667 5.3335H64V21.3335C64 27.2162 68.7837 32 74.6667 32H90.6667V117.333Z" fill="#193567"/>
                                                                <path d="M61.5963 78.2838C59.1275 76.341 56.7812 74.3438 55.2188 72.7813C53.1875 70.75 51.3775 68.7813 49.8047 66.9063C52.258 59.3255 53.3335 55.4168 53.3335 53.3333C53.3335 44.4818 50.1355 42.6665 45.3335 42.6665C41.685 42.6665 37.3335 44.5623 37.3335 53.5885C37.3335 57.5678 39.5132 62.3985 43.8335 68.013C42.7762 71.2395 41.534 74.961 40.1382 79.1563C39.4662 81.1693 38.7373 83.0338 37.9663 84.7578C37.3388 85.0365 36.7293 85.3203 36.1408 85.6145C34.021 86.6745 32.008 87.6275 30.1408 88.513C21.625 92.5443 16 95.211 16 100.477C16 104.3 20.1537 106.666 24 106.666C28.9583 106.666 36.4453 100.044 41.914 88.8877C47.591 86.6482 54.6485 84.9893 60.2188 83.9503C64.6823 87.3825 69.612 90.6665 72 90.6665C78.612 90.6665 80 86.8435 80 83.6378C80 77.333 72.7968 77.333 69.3333 77.333C68.2578 77.3333 65.3725 77.651 61.5963 78.2838ZM24 101.333C22.4765 101.333 21.4452 100.615 21.3332 100.477C21.3332 98.5858 26.9712 95.914 32.4245 93.3308C32.7707 93.1668 33.1225 93.0025 33.4793 92.8333C29.474 98.6408 25.513 101.333 24 101.333ZM42.6668 53.5885C42.6668 48 44.4012 48 45.3335 48C47.219 48 48.0003 48 48.0003 53.3333C48.0003 54.4583 47.2503 57.2708 45.8778 61.6615C43.7838 58.4375 42.6668 55.6745 42.6668 53.5885ZM44.711 82.25C44.8777 81.7865 45.0392 81.3178 45.1955 80.8438C46.185 77.875 47.0757 75.2083 47.87 72.8073C48.9767 74.026 50.1695 75.2735 51.4482 76.552C51.9482 77.052 53.1877 78.177 54.839 79.5857C51.552 80.302 48.0547 81.19 44.711 82.25ZM74.6667 83.638C74.6667 84.836 74.6667 85.3333 72.1927 85.349C71.4662 85.1928 69.7865 84.2032 67.7135 82.7917C68.466 82.7085 69.0208 82.6667 69.3333 82.6667C73.2735 82.6667 74.3907 83.052 74.6667 83.638Z" fill="#193567"/>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="kanban-bx">
                                                        <div class="doc-img">
                                                            <div class="form-check form-radio-success">
                                                                <input class="form-check-input" type="radio" name="rad6" id="">                                                            
                                                            </div>
                                                            <svg width="30" height="30" viewBox="0 0 60 61" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M52.333 0.5H7.66699C3.43934 0.5 0 3.93945 0 8.16711V52.833C0 57.0605 3.43934 60.5 7.66699 60.5H52.333C56.5607 60.5 60 57.0605 60 52.8329V8.16711C60 3.93945 56.5607 0.5 52.333 0.5ZM56.4659 52.833C56.4659 55.112 54.6118 56.9659 52.333 56.9659H7.66699C5.38805 56.9659 3.53402 55.1118 3.53402 52.833V46.3869L15.1655 36.4903C15.5899 36.1291 16.2091 36.1257 16.6376 36.4815L23.9236 42.5316C24.6261 43.1149 25.6574 43.0671 26.303 42.4208L43.615 25.0824C43.9279 24.7689 44.2927 24.7385 44.4831 24.7482C44.6729 24.7579 45.0333 24.8257 45.3125 25.1696L56.466 38.9028L56.4659 52.833ZM56.4659 33.2967L48.0558 22.9413C47.2218 21.9143 45.9855 21.2864 44.6641 21.2185C43.3437 21.1517 42.0489 21.6488 41.1141 22.5852L24.9413 38.7829L18.8955 33.7627C17.1425 32.307 14.6108 32.3221 12.8753 33.7988L3.53402 41.7467V8.16711C3.53402 5.88816 5.38805 4.03414 7.66699 4.03414H52.333C54.612 4.03414 56.4659 5.88816 56.4659 8.16711V33.2967Z" fill="#193567"/>
                                                                <path d="M18.8876 7.88208C14.1889 7.88208 10.3665 11.7047 10.3665 16.4031C10.3665 21.1017 14.1891 24.9242 18.8876 24.9242C23.5861 24.9242 27.4086 21.1017 27.4086 16.4031C27.4086 11.7046 23.5862 7.88208 18.8876 7.88208ZM18.8876 21.3902C16.1376 21.3902 13.9005 19.1529 13.9005 16.4031C13.9005 13.6532 16.1376 11.4161 18.8876 11.4161C21.6375 11.4161 23.8746 13.6533 23.8746 16.4031C23.8746 19.1529 21.6375 21.3902 18.8876 21.3902Z" fill="#193567"/>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="kanban-bx">
                                                        <div class="doc-img">
                                                            <div class="form-check form-radio-success">
                                                                <input class="form-check-input" type="radio" name="rad7" id="">                                                            
                                                            </div>
                                                            <svg width="30" height="34" viewBox="0 0 96 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M95.2188 27.448L68.552 0.78125C68.052 0.28125 67.375 0 66.6665 0H10.6665C4.78375 0 0 4.78375 0 10.6667V117.334C0 123.216 4.78375 128 10.6667 128H85.3335C91.2163 128 96 123.216 96 117.333V29.3333C96 28.625 95.7188 27.948 95.2188 27.448ZM69.3333 9.10425L86.8958 26.6667H74.6665C71.7265 26.6667 69.3333 24.2735 69.3333 21.3335V9.10425ZM90.6667 117.333C90.6667 120.273 88.2735 122.666 85.3335 122.666H10.6667C7.72675 122.666 5.3335 120.273 5.3335 117.333V10.6667C5.3335 7.72675 7.72675 5.3335 10.6667 5.3335H64V21.3335C64 27.2162 68.7837 32 74.6667 32H90.6667V117.333Z" fill="#193567"/>
                                                                <path d="M61.5963 78.2838C59.1275 76.341 56.7812 74.3438 55.2188 72.7813C53.1875 70.75 51.3775 68.7813 49.8047 66.9063C52.258 59.3255 53.3335 55.4168 53.3335 53.3333C53.3335 44.4818 50.1355 42.6665 45.3335 42.6665C41.685 42.6665 37.3335 44.5623 37.3335 53.5885C37.3335 57.5678 39.5132 62.3985 43.8335 68.013C42.7762 71.2395 41.534 74.961 40.1382 79.1563C39.4662 81.1693 38.7373 83.0338 37.9663 84.7578C37.3388 85.0365 36.7293 85.3203 36.1408 85.6145C34.021 86.6745 32.008 87.6275 30.1408 88.513C21.625 92.5443 16 95.211 16 100.477C16 104.3 20.1537 106.666 24 106.666C28.9583 106.666 36.4453 100.044 41.914 88.8877C47.591 86.6482 54.6485 84.9893 60.2188 83.9503C64.6823 87.3825 69.612 90.6665 72 90.6665C78.612 90.6665 80 86.8435 80 83.6378C80 77.333 72.7968 77.333 69.3333 77.333C68.2578 77.3333 65.3725 77.651 61.5963 78.2838ZM24 101.333C22.4765 101.333 21.4452 100.615 21.3332 100.477C21.3332 98.5858 26.9712 95.914 32.4245 93.3308C32.7707 93.1668 33.1225 93.0025 33.4793 92.8333C29.474 98.6408 25.513 101.333 24 101.333ZM42.6668 53.5885C42.6668 48 44.4012 48 45.3335 48C47.219 48 48.0003 48 48.0003 53.3333C48.0003 54.4583 47.2503 57.2708 45.8778 61.6615C43.7838 58.4375 42.6668 55.6745 42.6668 53.5885ZM44.711 82.25C44.8777 81.7865 45.0392 81.3178 45.1955 80.8438C46.185 77.875 47.0757 75.2083 47.87 72.8073C48.9767 74.026 50.1695 75.2735 51.4482 76.552C51.9482 77.052 53.1877 78.177 54.839 79.5857C51.552 80.302 48.0547 81.19 44.711 82.25ZM74.6667 83.638C74.6667 84.836 74.6667 85.3333 72.1927 85.349C71.4662 85.1928 69.7865 84.2032 67.7135 82.7917C68.466 82.7085 69.0208 82.6667 69.3333 82.6667C73.2735 82.6667 74.3907 83.052 74.6667 83.638Z" fill="#193567"/>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="kanban-bx">
                                                        <div class="doc-img">
                                                            <div class="form-check form-radio-success">
                                                                <input class="form-check-input" type="radio" name="rad8" id="">                                                            
                                                            </div>
                                                            <svg width="32" height="34" viewBox="0 0 131 136" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M15.3343 63.2044H11.569C5.33062 63.2044 0.273071 68.262 0.273071 74.5003V128.469C0.273071 132.629 3.64437 136 7.80367 136H123.273C125.27 136 127.185 135.207 128.598 133.794C130.01 132.382 130.804 130.467 130.804 128.469C130.804 118.851 130.804 97.9253 130.804 88.3066C130.804 86.3095 130.01 84.3937 128.598 82.9816C127.185 81.5694 125.27 80.776 123.273 80.776H118.252V33.082C118.252 32.5386 118.076 32.0103 117.75 31.5759L95.1586 1.4535C94.6845 0.821531 93.9405 0.449219 93.1507 0.449219H22.8649C20.8678 0.449219 18.952 1.24264 17.5398 2.65478C16.1277 4.06752 15.3343 5.9827 15.3343 7.97982V63.2044ZM123.273 85.7962H11.5641C9.31521 85.7962 7.13616 85.1257 5.29327 83.8949V128.47C5.29327 129.856 6.41744 130.98 7.80367 130.98H123.273C123.939 130.98 124.577 130.715 125.048 130.245C125.518 129.774 125.783 129.135 125.783 128.469V88.3066C125.783 87.6409 125.518 87.0023 125.048 86.5312C124.577 86.0607 123.939 85.7962 123.273 85.7962ZM31.0232 112.467H41.9793C46.326 112.467 49.8497 108.943 49.8497 104.597V101.197C49.8497 96.8505 46.326 93.3268 41.9793 93.3268C36.4139 93.3268 28.5128 93.3268 28.5128 93.3268C27.1266 93.3268 26.0024 94.4504 26.0024 95.8372V120.939C26.0024 122.324 27.1272 123.449 28.5128 123.449C29.8984 123.449 31.0232 122.324 31.0232 120.939V112.467ZM86.2472 112.467H97.2033C101.55 112.467 105.074 108.943 105.074 104.597V101.197C105.074 96.8505 101.55 93.3268 97.2033 93.3268C91.6385 93.3268 83.7374 93.3268 83.7374 93.3268C82.3506 93.3268 81.227 94.4504 81.227 95.8372V120.939C81.227 122.324 82.3518 123.449 83.7374 123.449C85.1224 123.449 86.2472 122.324 86.2472 120.939V112.467ZM70.8721 105.878H59.263C59.0461 105.878 58.8358 105.905 58.6352 105.957V95.8372C58.6352 94.4516 57.5104 93.3268 56.1248 93.3268C54.7398 93.3268 53.615 94.4516 53.615 95.8372V120.939C53.615 122.324 54.7398 123.449 56.1248 123.449C57.5104 123.449 58.6352 122.324 58.6352 120.939V110.819C58.84 110.871 59.0509 110.898 59.263 110.898H70.8721V120.939C70.8727 122.324 71.9975 123.449 73.3825 123.449C74.7682 123.449 75.8929 122.324 75.8929 120.939V95.8372C75.8929 94.4516 74.7682 93.3268 73.3825 93.3268C71.9975 93.3268 70.8727 94.4516 70.8721 95.8372V105.878ZM31.0232 107.446H41.9793C43.5529 107.446 44.8289 106.171 44.8289 104.597V101.197C44.8289 99.623 43.5529 98.347 41.9793 98.347H31.0232V107.446ZM86.2472 107.446H97.2033C98.7775 107.446 100.053 106.171 100.053 104.597V101.197C100.053 99.623 98.7775 98.347 97.2033 98.347H86.2472V107.446ZM90.6403 5.47002H22.8649C22.1992 5.47002 21.5606 5.73449 21.0901 6.20501C20.6189 6.67552 20.3545 7.31411 20.3545 7.97982V80.776H113.232V35.5924H98.1708C94.0115 35.5924 90.6403 32.2205 90.6403 28.0618V5.47002ZM15.3343 68.2246H11.569C8.10309 68.2246 5.29327 71.0344 5.29327 74.5003V74.5051C5.29327 76.1685 5.95415 77.7632 7.13013 78.9391C8.30611 80.1151 9.90079 80.776 11.5641 80.776H15.3343V68.2246ZM63.7108 68.8747L73.1277 33.7315C73.4862 32.3934 72.6909 31.0162 71.3529 30.6572C70.0142 30.2987 68.637 31.0939 68.278 32.4326L58.8617 67.5752C58.5033 68.9132 59.2985 70.291 60.6365 70.6495C61.9752 71.0079 63.3524 70.2127 63.7108 68.8747ZM77.5985 39.8776L88.316 50.5952L77.5985 61.3121C76.6189 62.2923 76.6189 63.8828 77.5985 64.8623C78.578 65.8419 80.1691 65.8419 81.1487 64.8623L93.641 52.37C94.6212 51.3898 94.6212 49.7999 93.641 48.8198L81.1487 36.3274C80.1691 35.3478 78.578 35.3478 77.5985 36.3274C76.6189 37.307 76.6189 38.898 77.5985 39.8776ZM49.928 36.3274L37.4357 48.8198C36.4549 49.7999 36.4549 51.3898 37.4357 52.37L49.928 64.8623C50.9076 65.8419 52.4981 65.8419 53.4777 64.8623C54.4572 63.8828 54.4572 62.2923 53.4777 61.3121L42.7601 50.5952L53.4777 39.8776C54.4572 38.898 54.4572 37.307 53.4777 36.3274C52.4981 35.3478 50.9076 35.3478 49.928 36.3274ZM95.6604 10.4902V28.0618C95.6604 29.448 96.7846 30.5716 98.1708 30.5716H110.722L95.6604 10.4902Z" fill="#193567"/>
                                                                </svg>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="kanban-bx">
                                                        <div class="doc-img">
                                                            <div class="form-check form-radio-success">
                                                                <input class="form-check-input" type="radio" name="rad9" id="">                                                            
                                                            </div>
                                                            <svg width="30" height="34" viewBox="0 0 96 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M95.2188 27.448L68.552 0.78125C68.052 0.28125 67.375 0 66.6665 0H10.6665C4.78375 0 0 4.78375 0 10.6667V117.334C0 123.216 4.78375 128 10.6667 128H85.3335C91.2163 128 96 123.216 96 117.333V29.3333C96 28.625 95.7188 27.948 95.2188 27.448ZM69.3333 9.10425L86.8958 26.6667H74.6665C71.7265 26.6667 69.3333 24.2735 69.3333 21.3335V9.10425ZM90.6667 117.333C90.6667 120.273 88.2735 122.666 85.3335 122.666H10.6667C7.72675 122.666 5.3335 120.273 5.3335 117.333V10.6667C5.3335 7.72675 7.72675 5.3335 10.6667 5.3335H64V21.3335C64 27.2162 68.7837 32 74.6667 32H90.6667V117.333Z" fill="#193567"/>
                                                                <path d="M61.5963 78.2838C59.1275 76.341 56.7812 74.3438 55.2188 72.7813C53.1875 70.75 51.3775 68.7813 49.8047 66.9063C52.258 59.3255 53.3335 55.4168 53.3335 53.3333C53.3335 44.4818 50.1355 42.6665 45.3335 42.6665C41.685 42.6665 37.3335 44.5623 37.3335 53.5885C37.3335 57.5678 39.5132 62.3985 43.8335 68.013C42.7762 71.2395 41.534 74.961 40.1382 79.1563C39.4662 81.1693 38.7373 83.0338 37.9663 84.7578C37.3388 85.0365 36.7293 85.3203 36.1408 85.6145C34.021 86.6745 32.008 87.6275 30.1408 88.513C21.625 92.5443 16 95.211 16 100.477C16 104.3 20.1537 106.666 24 106.666C28.9583 106.666 36.4453 100.044 41.914 88.8877C47.591 86.6482 54.6485 84.9893 60.2188 83.9503C64.6823 87.3825 69.612 90.6665 72 90.6665C78.612 90.6665 80 86.8435 80 83.6378C80 77.333 72.7968 77.333 69.3333 77.333C68.2578 77.3333 65.3725 77.651 61.5963 78.2838ZM24 101.333C22.4765 101.333 21.4452 100.615 21.3332 100.477C21.3332 98.5858 26.9712 95.914 32.4245 93.3308C32.7707 93.1668 33.1225 93.0025 33.4793 92.8333C29.474 98.6408 25.513 101.333 24 101.333ZM42.6668 53.5885C42.6668 48 44.4012 48 45.3335 48C47.219 48 48.0003 48 48.0003 53.3333C48.0003 54.4583 47.2503 57.2708 45.8778 61.6615C43.7838 58.4375 42.6668 55.6745 42.6668 53.5885ZM44.711 82.25C44.8777 81.7865 45.0392 81.3178 45.1955 80.8438C46.185 77.875 47.0757 75.2083 47.87 72.8073C48.9767 74.026 50.1695 75.2735 51.4482 76.552C51.9482 77.052 53.1877 78.177 54.839 79.5857C51.552 80.302 48.0547 81.19 44.711 82.25ZM74.6667 83.638C74.6667 84.836 74.6667 85.3333 72.1927 85.349C71.4662 85.1928 69.7865 84.2032 67.7135 82.7917C68.466 82.7085 69.0208 82.6667 69.3333 82.6667C73.2735 82.6667 74.3907 83.052 74.6667 83.638Z" fill="#193567"/>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="kanban-bx">
                                                        <div class="doc-img">
                                                            <div class="form-check form-radio-success">
                                                                <input class="form-check-input" type="radio" name="rad11" id="">                                                            
                                                            </div>
                                                            <svg width="30" height="30" viewBox="0 0 60 61" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M52.333 0.5H7.66699C3.43934 0.5 0 3.93945 0 8.16711V52.833C0 57.0605 3.43934 60.5 7.66699 60.5H52.333C56.5607 60.5 60 57.0605 60 52.8329V8.16711C60 3.93945 56.5607 0.5 52.333 0.5ZM56.4659 52.833C56.4659 55.112 54.6118 56.9659 52.333 56.9659H7.66699C5.38805 56.9659 3.53402 55.1118 3.53402 52.833V46.3869L15.1655 36.4903C15.5899 36.1291 16.2091 36.1257 16.6376 36.4815L23.9236 42.5316C24.6261 43.1149 25.6574 43.0671 26.303 42.4208L43.615 25.0824C43.9279 24.7689 44.2927 24.7385 44.4831 24.7482C44.6729 24.7579 45.0333 24.8257 45.3125 25.1696L56.466 38.9028L56.4659 52.833ZM56.4659 33.2967L48.0558 22.9413C47.2218 21.9143 45.9855 21.2864 44.6641 21.2185C43.3437 21.1517 42.0489 21.6488 41.1141 22.5852L24.9413 38.7829L18.8955 33.7627C17.1425 32.307 14.6108 32.3221 12.8753 33.7988L3.53402 41.7467V8.16711C3.53402 5.88816 5.38805 4.03414 7.66699 4.03414H52.333C54.612 4.03414 56.4659 5.88816 56.4659 8.16711V33.2967Z" fill="#193567"/>
                                                                <path d="M18.8876 7.88208C14.1889 7.88208 10.3665 11.7047 10.3665 16.4031C10.3665 21.1017 14.1891 24.9242 18.8876 24.9242C23.5861 24.9242 27.4086 21.1017 27.4086 16.4031C27.4086 11.7046 23.5862 7.88208 18.8876 7.88208ZM18.8876 21.3902C16.1376 21.3902 13.9005 19.1529 13.9005 16.4031C13.9005 13.6532 16.1376 11.4161 18.8876 11.4161C21.6375 11.4161 23.8746 13.6533 23.8746 16.4031C23.8746 19.1529 21.6375 21.3902 18.8876 21.3902Z" fill="#193567"/>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="kanban-bx">
                                                        <div class="doc-img">
                                                            <div class="form-check form-radio-success">
                                                                <input class="form-check-input" type="radio" name="rad12" id="">                                                            
                                                            </div>
                                                            <svg width="30" height="34" viewBox="0 0 96 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M95.2188 27.448L68.552 0.78125C68.052 0.28125 67.375 0 66.6665 0H10.6665C4.78375 0 0 4.78375 0 10.6667V117.334C0 123.216 4.78375 128 10.6667 128H85.3335C91.2163 128 96 123.216 96 117.333V29.3333C96 28.625 95.7188 27.948 95.2188 27.448ZM69.3333 9.10425L86.8958 26.6667H74.6665C71.7265 26.6667 69.3333 24.2735 69.3333 21.3335V9.10425ZM90.6667 117.333C90.6667 120.273 88.2735 122.666 85.3335 122.666H10.6667C7.72675 122.666 5.3335 120.273 5.3335 117.333V10.6667C5.3335 7.72675 7.72675 5.3335 10.6667 5.3335H64V21.3335C64 27.2162 68.7837 32 74.6667 32H90.6667V117.333Z" fill="#193567"/>
                                                                <path d="M61.5963 78.2838C59.1275 76.341 56.7812 74.3438 55.2188 72.7813C53.1875 70.75 51.3775 68.7813 49.8047 66.9063C52.258 59.3255 53.3335 55.4168 53.3335 53.3333C53.3335 44.4818 50.1355 42.6665 45.3335 42.6665C41.685 42.6665 37.3335 44.5623 37.3335 53.5885C37.3335 57.5678 39.5132 62.3985 43.8335 68.013C42.7762 71.2395 41.534 74.961 40.1382 79.1563C39.4662 81.1693 38.7373 83.0338 37.9663 84.7578C37.3388 85.0365 36.7293 85.3203 36.1408 85.6145C34.021 86.6745 32.008 87.6275 30.1408 88.513C21.625 92.5443 16 95.211 16 100.477C16 104.3 20.1537 106.666 24 106.666C28.9583 106.666 36.4453 100.044 41.914 88.8877C47.591 86.6482 54.6485 84.9893 60.2188 83.9503C64.6823 87.3825 69.612 90.6665 72 90.6665C78.612 90.6665 80 86.8435 80 83.6378C80 77.333 72.7968 77.333 69.3333 77.333C68.2578 77.3333 65.3725 77.651 61.5963 78.2838ZM24 101.333C22.4765 101.333 21.4452 100.615 21.3332 100.477C21.3332 98.5858 26.9712 95.914 32.4245 93.3308C32.7707 93.1668 33.1225 93.0025 33.4793 92.8333C29.474 98.6408 25.513 101.333 24 101.333ZM42.6668 53.5885C42.6668 48 44.4012 48 45.3335 48C47.219 48 48.0003 48 48.0003 53.3333C48.0003 54.4583 47.2503 57.2708 45.8778 61.6615C43.7838 58.4375 42.6668 55.6745 42.6668 53.5885ZM44.711 82.25C44.8777 81.7865 45.0392 81.3178 45.1955 80.8438C46.185 77.875 47.0757 75.2083 47.87 72.8073C48.9767 74.026 50.1695 75.2735 51.4482 76.552C51.9482 77.052 53.1877 78.177 54.839 79.5857C51.552 80.302 48.0547 81.19 44.711 82.25ZM74.6667 83.638C74.6667 84.836 74.6667 85.3333 72.1927 85.349C71.4662 85.1928 69.7865 84.2032 67.7135 82.7917C68.466 82.7085 69.0208 82.6667 69.3333 82.6667C73.2735 82.6667 74.3907 83.052 74.6667 83.638Z" fill="#193567"/>
                                ...
                                <div class="right-side-topbar">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <ul class="nav nav-pills event-tab-nav" role="tablist">
                                            ...
                                            <li class="nav-item waves-effect waves-light" role="presentation">
                                                <a class="nav-link active" data-bs-toggle="tab" href="#doc-list-tab2" role="tab"
                                                    aria-selected="false" tabindex="-1">
                                                    <button type="button"
                                                        class="btn btn-kanlist ml-15 waves-effect waves-light"
                                                        data-bs-toggle="tooltip" data-bs-placement="bottom" title="List">
                                            ...
                                            <li class="nav-item waves-effect waves-light" role="presentation">
                                                <a class="nav-link" data-bs-toggle="tab" href="#doc-grid-tab2" role="tab"
                                                    aria-selected="false" tabindex="-1">
                                                    <button type="button"
                                                        class="btn btn-kanlist ml-15 waves-effect waves-light"
                                                        data-bs-toggle="tooltip" data-bs-placement="bottom" title="Grid">
                                ...
                                <div class="right-side-topbar">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <ul class="nav nav-pills event-tab-nav" role="tablist">
                                            ...
                                            <li class="nav-item waves-effect waves-light" role="presentation">
                                                <a class="nav-link active" data-bs-toggle="tab" href="#doc-list-tab3" role="tab"
                                                    aria-selected="false" tabindex="-1">
                                                    <button type="button"
                                                        class="btn btn-kanlist ml-15 waves-effect waves-light"
                                                        data-bs-toggle="tooltip" data-bs-placement="bottom" title="List">
                                            ...
                                            <li class="nav-item waves-effect waves-light" role="presentation">
                                                <a class="nav-link" data-bs-toggle="tab" href="#doc-grid-tab3" role="tab"
                                                    aria-selected="false" tabindex="-1">
                                                    <button type="button"
                                                        class="btn btn-kanlist ml-15 waves-effect waves-light"
                                                        data-bs-toggle="tooltip" data-bs-placement="bottom" title="Grid">
                                ...
                                <div class="right-side-topbar">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <ul class="nav nav-pills event-tab-nav" role="tablist">
                                            ...
                                            <li class="nav-item waves-effect waves-light" role="presentation">
                                                <a class="nav-link active" data-bs-toggle="tab" href="#doc-list-tab4" role="tab"
                                                    aria-selected="false" tabindex="-1">
                                                    <button type="button"
                                                        class="btn btn-kanlist ml-15 waves-effect waves-light"
                                                        data-bs-toggle="tooltip" data-bs-placement="bottom" title="List">
                                            ...
                                            <li class="nav-item waves-effect waves-light" role="presentation">
                                                <a class="nav-link" data-bs-toggle="tab" href="#doc-grid-tab4" role="tab"
                                                    aria-selected="false" tabindex="-1">
                                                    <button type="button"
                                                        class="btn btn-kanlist ml-15 waves-effect waves-light"
                                                        data-bs-toggle="tooltip" data-bs-placement="bottom" title="Grid">
                                ...
                                <div class="right-side-topbar">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <ul class="nav nav-pills event-tab-nav" role="tablist">
                                            ...
                                            <li class="nav-item waves-effect waves-light" role="presentation">
                                                <a class="nav-link active" data-bs-toggle="tab" href="#doc-list-tab5" role="tab"
                                                    aria-selected="false" tabindex="-1">
                                                    <button type="button"
                                                        class="btn btn-kanlist ml-15 waves-effect waves-light"
                                                        data-bs-toggle="tooltip" data-bs-placement="bottom" title="List">
                                            ...
                                            <li class="nav-item waves-effect waves-light" role="presentation">
                                                <a class="nav-link" data-bs-toggle="tab" href="#doc-grid-tab5" role="tab"
                                                    aria-selected="false" tabindex="-1">
                                                    <button type="button"
                                                        class="btn btn-kanlist ml-15 waves-effect waves-light"
                                                        data-bs-toggle="tooltip" data-bs-placement="bottom" title="Grid">
        ...
        <div class="modal fade" id="create-section" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light br-50 btn-md" data-bs-toggle="modal">Close</button>
        ...
        <div class="modal fade" id="create-folder" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
