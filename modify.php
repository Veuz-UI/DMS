                                ...
                                <div class="file-detail-tab">
                                   <div class="row h-100">
                                    <div class="col-md-12">
                                        ...
                                        <div class="doc-details doc-detail-box">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="row gx-2">
                                                        <div class="col-md-8">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="Arshad">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="row gx-2">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="ocr-lang">
                                                                <div class="form-group">
                                                                    <div class="form-check form-radio-outline form-radio-success evnt-radio">
                                                                        <input class="form-check-input" type="checkbox" name="formRadio61" id="formRadio61">
                                                                        <label class="form-check-label" for="formRadio61">
                                                                            Apply this language to all folders
                                                                        </label>
                                                                    </div>
                                                                    <div class="form-check form-radio-outline form-radio-success evnt-radio">
                                                                        <input class="form-check-input" type="checkbox" name="formRadio62" id="formRadio62">
                                                                        <label class="form-check-label" for="formRadio62">
                                                                            Apply this language to all existing files
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="row gx-2">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="">Date</label>
                                                                        <input type="date" class="form-control" placeholder="14 Nov 2023">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="">Due date</label>
                                                                        <input type="date" class="form-control" placeholder="18 Nov 2023">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="">Document number</label>
                                                                <input type="text" class="form-control" placeholder="13498153">
                                                            </div>
                                                        </div>
                                                    </div>
